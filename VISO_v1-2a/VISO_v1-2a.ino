/* VISO v1.2 Source Code for Device 1
 *
...
const char TITLE[20] = "VISO v1.2 Dev 1";
 ...
 * Signal pin is connected to pin 0, and values are fetched using
...
void setup() 
{
  ...
  Serial.printf("VISO v1.2 Device 1\n\n");
